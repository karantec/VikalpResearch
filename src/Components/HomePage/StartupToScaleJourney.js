      ...
      <div className="max-w-7xl mx-auto px-4 py-10 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 gap-10 mb-10">
              ...
              <div className="flex justify-center items-center">
                <img
                  ...
                  className="rounded-xl shadow-lg w-full sm:w-auto max-w-sm object-contain p-2"
                />
              </div>
            </div>

            {/* Testimonial Card 1 */}
            <div className="relative -mt-40 -pb-16">
              <div className="bg-gradient-to-r from-red-600 to-rose-600 p-8 rounded-2xl shadow-lg transform rotate-1">
        ...
        <section className="mb-20">
          <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-red-600">
            ...
            {/* Testimonial Card 3 */}
            <div className="relative -mt-40 -pb-16">
              <div className="relative -mt-28 -pb-16">
                <div className="bg-gradient-to-r from-red-600 to-rose-600 p-8 rounded-2xl shadow-lg transform rotate-1">
                  <div className="flex flex-col sm:flex-row  gap-6">
                    <div className="flex-shrink-0">
                      <img
                        ...
                        alt="Client"
                        className="w-52 h-52 sm:w-36 sm:h-36 shadow-xl object-cover"
                      />
                    </div>
                    <div className="text-white flex-1 -mb-4">
                      ...
                      <p className="sm:text-lg  mb-6">
                        ...
                        smoothly. His ongoing support has been invaluable,
                        making the entire process seamless. Parmjeet Singh,.
                      </p>
